...
public class JsonConfig {
	 ...
	 * The events will be triggered only when using the static builders and if event
	 * triggering is enabled.<br>
	 * [Java -&gt; JSON]
	 * 
	...
	/**
	 * Returns true if this Jettison convention will be handled when converting to
	 * Java.<br>
	 ...
	 * Returns true if this jettison convention will be handled when converting to
	 * Java.<br>
	 * Jettison states the following JSON {'media':{'title':'hello'}} can be set as
	 * a single element JSONArray (media is the array).<br>
	 * [JSON -&gt; Java]
	 */
	 ...
	 * If the value is not MODE_LIST, MODE_OBJECT_ARRAY nor MODE_SET, then MODE_LIST
	 * will be used.<br>
	 * [JSON -&gt; Java]
	 * 
	 * @param arrayMode
