...
public abstract class NewBeanInstanceStrategy {
	 ...
	 *            the source class
	 * @param source
	 *            additional properties that may be needed to create the instance
	 */
	public abstract Object newInstance(Class target, JSONObject source) throws InstantiationException,
