...
//		return s;
	 ...
	 * otherwise the value is transformed to a String an its hashcode is returned.
	 */
...
//		return s;
	 ...
	 * function, translation of characters will not take place. This will produce a
	 * non-conformant JSON text.
	 *
	 * @param string
	 *            A String
...
//		return input;
	 ...
	 *
	 * @return true if n is instanceOf Double or the literal value can be evaluated
	 *         as a Double.
	 */
	 ...
	 *
	 * @return true if n is instanceOf Float or the literal value can be evaluated
	 *         as a Float.
	 */
	 ...
	 *
	 * @return true if n is instanceOf Integer or the literal value can be evaluated
	 *         as an Integer.
	 */
	 ...
	 *
	 * @return true if n is instanceOf Long or the literal value can be evaluated as
	 *         a Long.
	 */
